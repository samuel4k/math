...
START_TEXT = """
Hello {}, I am a Simple Telegram [Calculator-Bot](https://Github.com/ZauteKm/Calculator-Bot).
...
START_BUTTONS = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton('🔥 Join Channel 📢', url='https://telegram.me/TGBotsProJect')
        ]]
    )
